...
from src import SentClasLSTM, SentRegLSTM, SentRegAttLSTM



if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("-m", "--model", help="specify model type between \{SC, SR, SRA\}", type=str, default="SR")
    ...
    trainer = Trainer(max_epochs=args.epoch, lr=args.lr, run_on_gpu=True)
